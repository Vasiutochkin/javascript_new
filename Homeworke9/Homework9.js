...
//
// newElement.setAttribute('slass', 'wrap collapse alpha beta');
//
// // - додати стилі(довільні значення) : колір фону, колір тексту, розмір тексту
// newElement.innerHTML = ' golk hkol jko';
// newElement.style.border = '2px solid #938686';
// newElement.style.background = 'burlywood';
// newElement.style.height = '20px';
// newElement.style.fontSize = '20px';
// newElement.style.color = '#51c42a';
//
// // - додати цей блок в body.
// document.body.append(newElement);
//
// // - клонувати його повністю, та додати клон в body.
// document.body.append(newElement.cloneNode(true));
...
// for (const ma of mas) {
//     let getElementsByClassName = document.getElementsByClassName('menu')[0];
//     let htmlLiElement = document.createElement('li');
//     htmlLiElement.innerHTML = ma;
//     getElementsByClassName.appendChild(htmlLiElement);
// }
...
//
//     divElement.append(h1, htmlParagraphElement);
...
//     htmlDivElement.className = 'member';
//
